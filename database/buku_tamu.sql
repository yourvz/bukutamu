-- Create Database
CREATE DATABASE IF NOT EXISTS buku_tamu_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE USER IF NOT EXISTS 'buku_tamu_app'@'localhost' IDENTIFIED BY 'secure_password_here';
GRANT SELECT, INSERT, UPDATE, DELETE ON buku_tamu_db.* TO 'buku_tamu_app'@'localhost';
FLUSH PRIVILEGES;